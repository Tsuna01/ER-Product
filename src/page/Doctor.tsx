                ...
                {isFirstView ? (
                    <div className="flex items-center justify-between">
                        ...
                        <div className="ml-130 border-blue-200 border-2 rounded-lg">
                            ...
                            <button
                                onClick={toggleView}
                                className=" absolute text-white font-bold text-lg bg-blue-500 p-2 ml-25 rounded-xl cursor-pointer hover:bg-red-400 
                            ">สลับหน้า</button>
                        </div>
                    </div>
                ) : (
                    <div className="flex items-center justify-between">
                        ...
                        <div className="ml-130 rounded-lg">
                            <Link to='/doctor/StaffForm' className='mr-5 p-2 border-b-4 shadow-lg border-blue-200 bg-white rounded-lg hover:bg-red-400 hover:border-red-300'>
                            <span className="text-red-500">Sta</span>
                            <span className="text-amber-500 ">ff</span>
                            <span className="text-green-500">Form</span>
                            </Link>
                            <Link to='/doctor/WardForm' className='mr-5 p-2 border-b-4 shadow-lg border-blue-200 bg-white rounded-lg hover:bg-red-400 hover:border-red-300'>
                            <span className="text-amber-500 ">Ward</span>
                            <span className="text-green-500">Form</span>
                            </Link>
                            <button
                                onClick={toggleView}
